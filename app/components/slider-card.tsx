...
function SliderCard({ cards }: Props) {
  return (
    <div className="flex flex-col gap-40 md:gap-10">
      {cards.map((card, i) => (
        <div key={i} className="relative m-auto bg-white p-6 pt-40 rounded-sm duration-300 transition-all w-full md:rounded-md md:bg-clip-padding md:border-[10px] md:border-white/25 md:pt-20">
          {/* <Swiper
        spaceBetween={30}
        effect="fade"
        loop={false}
